    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap'>
          ...
          <button 
            className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black rounded-[10px] text-[18px] flex gap-2 cursor-pointer'
          ...
          <button 
            className='px-[20px] py-[10px] lg:bg-white bg-black lg:text-black text-white rounded-[10px] text-[18px] flex gap-2 cursor-pointer items-center'
            onClick={()=>navigate("/searchwithai")}
          >
            Search with AI 
            <img src={ai} className='w-[30px] h-[30px] hidden lg:block' alt="" />
            <img src={ai1} className='w-[35px] h-[35px] lg:hidden' alt="" />
          </button>
