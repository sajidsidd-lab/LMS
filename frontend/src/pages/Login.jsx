...
function Login() {
   ...
   const handleLogin = async () => {
    ...
    try {
        ...
        console.log("Login Result:", result.data) // 🔥 DEBUG
...
<div className="w-[50%] h-full rounded-r-2xl bg-black md:flex items-center justify-center flex-col hidden p-8 text-center">

  <img 
    src={logo} 
    className="w-36 shadow-2xl mb-6"
    alt="logo"
  />

  <p className="text-white text-3xl font-bold leading-snug max-w-[320px] drop-shadow-[0_6px_20px_rgba(59,130,246,0.8)]">
    AI Driven <br /> Personalized Education Platform
  </p>
